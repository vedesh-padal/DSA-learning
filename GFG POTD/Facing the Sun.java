// Given an array height representing the heights of buildings. You have to count the 
// buildings that will see the sunrise (Assume the sun rises on the side of the array starting point).
