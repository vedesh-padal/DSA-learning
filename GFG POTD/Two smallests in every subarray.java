...
// Input: arr = [1]
// Output: -1
// Explanation: Here the size of array is 1, but we need minimum 2 elements.
...
class Solution {
  public int pairWithMaxSum(int[] arr) {
    ...
    // in a subarray (consecutive)
    // to find the min. two elements in them
    // at the same time maximizing their sum among all subarrays

    // we just find if the sum of the curr. and prev. element
    // if that is more then, we keep track of it
