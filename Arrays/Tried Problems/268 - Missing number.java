// EASY
// arrays, bit-manipulation, hash-table, sorting
...
class Solution {
    ...
    // using bit-manipulation, can also be done using the sum of numbers from 0-n, and subtracting to find the missing number
    ...
    // =================================================================
    public int missingNumber_usingCyclicSort(int[] nums) {
        // using Cyclic sort - single pass
